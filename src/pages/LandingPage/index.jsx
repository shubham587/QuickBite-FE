      ...
      <div className='relative m-auto max-h-dvh max-w-dvw'>
        <div className="relative max-w-full max-h-dvh  border">
          ...
          text-center p-4">
            ...
            <Button className='mt-2 w-64 b p-6 bg-orange-500 rounded-full text-white text-3xl hover:text-orange-500 hover:bg-white' onClick={() => console.log("first")}>Order food</Button>
          </div>
        </div>
      </div>
